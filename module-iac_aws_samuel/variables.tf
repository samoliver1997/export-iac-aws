...
variable "aws_subnet_subnet_0838db44_availability_zone" {
  default = "us-east-1a"
}
...
variable "aws_subnet_subnet_ac7f2cca_availability_zone" {
  default = "us-east-1c"
}
...
variable "aws_subnet_subnet_d22530dc_availability_zone" {
  default = "us-east-1f"
}
