resource "aws_iam_role" "tfer--AWSServiceRoleForAWSLicenseManagerRole" {
...
POLICY
  ...
  managed_policy_arns  = ["arn:aws:iam::aws:policy/aws-service-role/AWSLicenseManagerServiceRolePolicy"]
